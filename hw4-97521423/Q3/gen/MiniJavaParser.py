# Generated from C:/Users/alifa/OneDrive/term 6/Compiler/HW4/Q3\MiniJavaParser.g4 by ANTLR 4.9.1
# encoding: utf-8
from antlr4 import *
...
class MiniJavaParser ( Parser ):
    ...
    ruleNames =  [ "program", "mainClass", "classDeclaration", "varDeclaration", 
                   "methodDeclaration", "type_2", "statement", "expression", 
                   "identifier" ]
    ...
    class VarDeclarationContext(ParserRuleContext):
        ...
        def type_2(self):
            return self.getTypedRuleContext(MiniJavaParser.Type_2Context,0)
    ...
    class MethodDeclarationContext(ParserRuleContext):
        ...
        def type_2(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MiniJavaParser.Type_2Context)
            else:
                return self.getTypedRuleContext(MiniJavaParser.Type_2Context,i)
    ...
    def methodDeclaration(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MiniJavaParser.IF) | (1 << MiniJavaParser.WHILE) | (1 << MiniJavaParser.SOUT) | (1 << MiniJavaParser.LBRACE) | (1 << MiniJavaParser.IDENTIFIER))) != 0):
                self.state = 97
                localctx.s = self.statement()
                print(localctx.s.value_attr)
                self.state = 104
    ...
    class Type_2Context(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return MiniJavaParser.RULE_type_2

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterType_2" ):
                listener.enterType_2(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitType_2" ):
                listener.exitType_2(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitType_2" ):
                return visitor.visitType_2(self)
            else:
                return visitor.visitChildren(self)
    ...
    def type_2(self):
        ...
        localctx = MiniJavaParser.Type_2Context(self, self._ctx, self.state)
        self.enterRule(localctx, 10, self.RULE_type_2)
        try:
            self.state = 116
            self._errHandler.sync(self)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self._errHandler.sync(self)
                        _la = self._input.LA(1)
                        if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << MiniJavaParser.NOT) | (1 << MiniJavaParser.NEW) | (1 << MiniJavaParser.THIS) | (1 << MiniJavaParser.LPAREN) | (1 << MiniJavaParser.TRUE) | (1 << MiniJavaParser.FALSE) | (1 << MiniJavaParser.IDENTIFIER) | (1 << MiniJavaParser.INTEGER_LITERAL))) != 0):
                            self.state = 310
                            self.expression(0)
                            self.state = 315
                            self._errHandler.sync(self)
